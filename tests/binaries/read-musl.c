...
/**
 * This is a variant of read.c which uses musl's implementation of read()
 * rather than directly invoking syscall(SYS_read, ...).
 * This serves as a regression test for issue #21.
 *
